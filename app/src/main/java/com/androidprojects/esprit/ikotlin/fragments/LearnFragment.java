...
public class LearnFragment extends Fragment {
    ...
    private void prepareListData(){
        ...
        gettingStartedCourse.add("Kotlin/Native");
        ...
        classesAndObjectsCourse.add("Seales classes");
        ...
        othersCourse.add("Destructuring declarations");othersCourse.add("Collections");othersCourse.add("Ranges");othersCourse.add("Ranges");othersCourse.add("Type Checks and casts");othersCourse.add("This expressions");
    ...
    public static void dismissList(){
        dialog.dismiss();
    }
