...
public interface Parallaxor {
     ...
     *
     * @param view        View to move when this moves
     * @param transformer how do we want to move the view? (null default to {@link com.androidprojects.esprit.pralloid.transform.LinearTransformer})
     * @param multiplier  1.0f is the normal amount, a 1:1 ratio, 0.5f would move at half the distance of this view etc..
     */
    public void parallaxViewBy(View view, com.androidprojects.esprit.pralloid.transform.Transformer transformer, float multiplier);
